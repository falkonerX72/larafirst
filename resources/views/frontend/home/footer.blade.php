@php
    ...
    $blog_posts = App\Models\BlogPost::latest()
        ->limit(2)
        ->get();
@endphp
                            ...
                            @foreach ($blog_posts as $blog)
                                <div class="post">
                                    <figure class="post-thumb"><a
                                            href="{{ url('blog/details/' . $blog->post_slug) }}"><img
                                                src="{{ asset($blog->post_image) }}" alt=""></a></figure>
                                    <h5><a
                                            href="{{ url('blog/details/' . $blog->post_slug) }}">{{ $blog->post_title }}</a>
                                    </h5>
                        ...
                        <div class="widget-content">
                            <ul class="info-list clearfix">
                                ...
                                <li><i class="fas fa-microphone"></i><a
                                        href="tel:23055873407">+{{ $sitesetting->support_phone }}</a></li>
                                <li><i class="fas fa-envelope"></i><a
                                        href="mailto:info@example.com">{{ $sitesetting->email }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="auto-container">
            <div class="inner-box clearfix">
                ...
                <div class="copyright pull-left">
                    <p><a href="index.html">{{ $sitesetting->copyright }}</p>
                </div>
