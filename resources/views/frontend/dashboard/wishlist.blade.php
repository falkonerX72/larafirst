...
@section('main')
    ...
    <section class="page-title-two bg-color-1 centred">
        <div class="pattern-layer">
            <div class="pattern-1" style="background-image: url({{ asset('frontend/assets/images/shape/shape-2.jpg') }});">
            </div>
...
<div id="wishlist">
    ...
    <section class="subscribe-section bg-color-3">
        ...
        <div class="pattern-1" style="background-image: url({{ asset('frontend/assets/images/shape/shape-2.png]') }});">
            <div class="auto-container">
                <div class="row clearfix">
