<div class="widget-content">
    <ul class="category-list ">
        ...
        <li><a href="{{ route('user.profile') }}"><i class="fa fa-cog" aria-hidden="true"></i>
                Settings</a></li>
        <li><a href="{{ route('user.schedule.request') }}"><i class="fa fa-credit-card" aria-hidden="true"></i> schedule request <span class="badge badge-info">( 10 credits)</span></a></li>
        ...
        <li><a href="{{ route('user.change.password') }}"><i class="fa fa-key" aria-hidden="true"></i> PassWord
            </a></li>  
