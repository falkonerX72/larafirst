...
class WishlistController extends Controller
{
    public function AddToWishList(Request $request, $property_id)
    {
        ...
        if (Auth::check()) {
            ...
            if (!$exists) {
                ...
                return response()->json(['success' => 'Successfully Added On Your "<a href="http://127.0.0.1:8000/user/wishlist">wishlist</a>"']);
            } else {
    ...
    {
        $id = Auth::user()->id;
        $wishlist = Wishlist::with('property')->where('user_id', $id)->latest()->get();
    ...
    public function WishlistRemove($id)
    {
        ...
        return response()->json(['success' => 'successfully removed from wish list']);
    }
}
